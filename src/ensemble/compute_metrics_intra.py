...
def get_parser():
    ...
    parser = argparse.ArgumentParser(description='Compute intra metrics.')
...
if __name__ == '__main__':
    ...
    df = pd.DataFrame(
        columns=['folder0', 'folder1', 'gan0', 'gan1', 'step0', 'step1', 'time', 'fid', 'prc', 'rec', 'f1_prc_rec', 'dns', 'cvg', 'f1_dns_cvg'])
