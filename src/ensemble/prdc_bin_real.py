...
if __name__ == '__main__':
    ...
    filename = f'history_prdc_bin_real_{split}_{eval_backbone}_{post_resizer}_{n_samples}'
    ...
    df = pd.DataFrame(columns=['folder0', 'folder1', 'gan0', 'gan1', 'step0', 'step1', 'time', 'prc', 'rec', 'dns', 'cvg'])
