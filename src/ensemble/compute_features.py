...
def get_parser():
    ...
    parser.add_argument('--dataset_name', type=str, default='pneumoniamnist', choices=['pneumoniamnist', 'retinamnist', 'pneumoniamnist'], help='The name of dataset')
    ...
    parser.add_argument('--eval_backbone', type=str, default='resnet_ae_50_pneumoniamnist', help="[InceptionV3_torch, ResNet50_torch, SwAV_torch, resnet_ae_50_pneumoniamnist, disc_resnet_50_pneumoniamnist, cnn_resnet_50_pneumoniamnist, resnet_ae_50_retinamnist, disc_resnet_50_retinamnist, cnn_resnet_50_retinamnist, resnet_ae_50_breastmnist, disc_resnet_50_breastmnist, cnn_resnet_50_breastmnist")
...
if __name__ == '__main__':
    ...
    for gan_folder in tqdm(gan_folders, total=len(gan_folders)):
        ...
        # Dataloder
        dataloader = torch.utils.data.DataLoader(gan_datasetgan_dataset, batch_size=batch_size, shuffle=False)
