...
class Dataset_(Dataset):
    def __init__(self,
        ...
        self.cfgs = cfgs
        self.grayscale = True if data_name in ["pneumoniamnist", "breastmnist", "chestmnist", "organamnist", "octmnist", "AIforCOVID"] else False
        self.split = split
    ...
    def load_dataset(self):
        ...
        # Custom codes for MedMnist datasets.
        elif self.data_name in ["pathmnist", "chestmnist", "dermamnist", "octmnist", "pneumoniamnist", "retinamnist", "breastmnist", "bloodmnist", "organamnist"]:
            ...
            if self.data_name == "pathmnist":
                info = INFO['pathmnist']
            elif self.data_name == "chestmnist":
                info = INFO['chestmnist']
            elif self.data_name == "dermamnist":
                info = INFO['dermamnist']
            elif self.data_name == "octmnist":
                info = INFO['octmnist']
            ...
            elif self.data_name == "bloodmnist":
        ...
        # Custom code for AI4Covid CXR
            ...
            self.data = util_data.AIforCOVIDImg(data=fold_data, classes=self.cfgs.DATA.classes, cfg_data=self.cfgs.DATA.modes['img'], img_size=self.cfgs.DATA.img_size)
        else:
            if self.split is None:
                mode = "train" if self.train == True else "val"
            else:
