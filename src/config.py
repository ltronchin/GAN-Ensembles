...
class Configurations(object):
    ...
    def load_base_cfgs(self):
        ...
        self.PRE.apply_rflip = False # True # Added -> changes to False
        ...
        # cr (bcr, diffaugment, ada, simclr, byol) indicates differentiable augmentations used in the original paper
    ...
    def define_augments(self, device):
        ...
        ada_augpipe = {
            ...
            'custom': dict(xflip=1, xint=1, scale=1, rotate=1, aniso=1, xfrac=1),
        ...
        if self.AUG.apply_diffaug:
            ...
            elif self.AUG.diffaug_type in ["blit", "geom", "color", "filter", "noise", "cutout", "custom", "bg", "bgc", "bgcf", "bgcfn", "bgcfnc"]:
        ...
        if self.AUG.apply_ada:
            assert self.AUG.ada_aug_type in ["blit", "geom", "color", "filter", "noise", "cutout", "custom", "bg", "bgc", "bgcf", "bgcfn",
        ...
        if self.LOSS.apply_cr:
            ...
            elif self.AUG.cr_aug_type in ["blit", "geom", "color", "filter", "noise", "cutout", "custom", "bg", "bgc", "bgcf", "bgcfn", "bgcfnc"]:
        ...
        if self.LOSS.apply_bcr:
            ...
            if self.AUG.bcr_aug_type == "bcr":
                ...
                self.AUG.parallel_augment = simclr_aug.SimclrAugment(aug_type=self.AUG.diffaug).train().to(device).requires_grad_(False)
            elif self.AUG.bcr_aug_type in ["blit", "geom", "color", "filter", "noise", "cutout", "custom", "bg", "bgc", "bgcf", "bgcfn", "bgcfnc"]:
