...
def calculate_pr_dc(real_feats, fake_feats, num_generate, nearest_k):
    real_embeds = copy.deepcopy(real_feats)
    fake_embeds = np.array(fake_feats, dtype=np.float64)[:num_generate]
