...
def get_parser():
    ...
    parser.add_argument('--n_train', type=int, default=10, help='Number of times the experiment is repeated.')
    ...
    parser.add_argument('--n_times', type=int, default=20, help='Number of times of training real dataset.')
...
if __name__ == "__main__":
    ...
    report_dir = os.path.join(save_dir, 'downstream_task_randomness', run_name)
