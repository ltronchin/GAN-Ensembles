...
def load_configs_initialize_training():
    ...
    parser.add_argument("--save_fake_as_tiff",  action="store_true", help="if save fake images as png or not") # added
    ...
    parser.add_argument("--save_freq", type=int, default=1000, help="save interval")
...
if __name__ == "__main__":
    ...
    # Required to avoid Ninja incompatibility
    my_env = os.environ.copy()
    my_env["PATH"] = "/home/lorenzo/miniconda3/envs/gan-ensemble/bin:" + my_env["PATH"]
